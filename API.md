...
| <code><a href="#lerna-projen.LernaProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#lerna-projen.LernaProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="lerna-projen.LernaProjectOptions.property.allowScripts"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="lerna-projen.LernaProjectOptions.property.npmTrustedPublishing"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="lerna-projen.LernaProjectOptions.property.pnpmOptions"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="lerna-projen.LernaProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="lerna-projen.LernaProjectOptions.property.releaseWorkflowEnv"></a>
...
| <code><a href="#lerna-projen.LernaTypescriptProjectOptions.property.allowScripts">allowScripts</a></code> | <code>string[]</code> | List of dependency (package) names that are allowed to run lifecycle install scripts (`preinstall`, `install`, `postinstall`, `prepare`) during dependency installation. |
...
| <code><a href="#lerna-projen.LernaTypescriptProjectOptions.property.pnpmOptions">pnpmOptions</a></code> | <code>projen.javascript.PnpmOptions</code> | Options for pnpm. |
...
##### `allowScripts`<sup>Optional</sup> <a name="allowScripts" id="lerna-projen.LernaTypescriptProjectOptions.property.allowScripts"></a>
...
##### `npmTrustedPublishing`<sup>Optional</sup> <a name="npmTrustedPublishing" id="lerna-projen.LernaTypescriptProjectOptions.property.npmTrustedPublishing"></a>
...
##### `pnpmOptions`<sup>Optional</sup> <a name="pnpmOptions" id="lerna-projen.LernaTypescriptProjectOptions.property.pnpmOptions"></a>
...
##### `releaseEnvironment`<sup>Optional</sup> <a name="releaseEnvironment" id="lerna-projen.LernaTypescriptProjectOptions.property.releaseEnvironment"></a>
...
##### `releaseWorkflowEnv`<sup>Optional</sup> <a name="releaseWorkflowEnv" id="lerna-projen.LernaTypescriptProjectOptions.property.releaseWorkflowEnv"></a>
